...
const Avatar = ({image , onClick , style , height , width , borderColor,onBlur}) => {
    ...
    return (
        <button style = {{ height : height && height , width : width && width , borderColor : borderColor && borderColor}} onClick={() => {onClick && onClick()}} onBlur={()=>onBlur&& onBlur()} className='avatar__full-div'>
