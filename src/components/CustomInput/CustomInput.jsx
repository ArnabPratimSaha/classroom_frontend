...
const CustomInput = ({type, placeholder, wrapperStyle, inputStyle},ref) => {

    

    return (
        <div style = {wrapperStyle ? wrapperStyle : {}} className="custom-input__wrapper">
            <input ref = {ref} className="custom-input" style = {inputStyle ? inputStyle : {}} type={type ? type : 'text'} required/>
